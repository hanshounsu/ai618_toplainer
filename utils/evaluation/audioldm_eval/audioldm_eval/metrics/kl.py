...
def calculate_kl(featuresdict_1, featuresdict_2, feat_layer_name, same_name=True):
    ...
    paths_1 = ['_'.join(os.path.basename(x).split('_')[:-2]) for x in featuresdict_1["file_path_"]]
    paths_2 = [os.path.splitext(os.path.basename(x))[0] for x in featuresdict_2["file_path_"]]
