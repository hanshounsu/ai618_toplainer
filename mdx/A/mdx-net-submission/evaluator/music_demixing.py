...
class MusicDemixingPredictor:
    def __init__(self, model_name='kuielab_mdxnet_A'):
        self.test_data_path = os.getenv("TEST_DATASET_PATH", os.getcwd() + "/data/test_adam/")
        self.results_data_path = os.getenv("RESULTS_DATASET_PATH", os.getcwd() + "/data/results_adam/" + model_name)
