...
class MusicDemixingPredictor:
    def __init__(self, model_name='baseline'):
        self.test_data_path = os.getenv("TEST_DATASET_PATH", os.getcwd() + "/data/test_mackenzie/")
        self.results_data_path = os.getenv("RESULTS_DATASET_PATH", os.getcwd() + "/data/results_mackenzie/" + model_name)
    ...
    def evaluation(self):
        ...
        for music_name in tqdm(music_names):
            ...
            if os.path.exists(os.path.join(self.results_data_path, music_name, 'bass.wav')):
                continue
